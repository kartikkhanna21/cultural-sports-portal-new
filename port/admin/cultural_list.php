...
<html lang="en">
<head> 
    <title> Sports and Cultural Report </title>
    <meta charset="utf-8">
...
$date=$_POST['Date'];
$active="YES";
$sql="INSERT into `cultural_list`(event_name,date,activity) values ('$event' , '$date' , '$active')";
...
<?php
$sql="SELECT id,event_name,date,activity FROM cultural_list";
